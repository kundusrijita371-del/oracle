      ...
      <div className="clay-card-yellow p-7 sm:p-8 rounded-[40px] border-4 border-white space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          ...
          <div className="p-4 rounded-3xl bg-white shadow-sm border border-white space-y-1">
            ...
            <div className="text-2xl font-black text-[#2C5D83]">{1.0 + (profile.streak_days * 0.1).toFixed(1)}x 🔥</div>
            <div className="text-[10px] font-bold text-[#446580]">{profile.streak_days}-Day Streak Bonus</div>
          </div>
