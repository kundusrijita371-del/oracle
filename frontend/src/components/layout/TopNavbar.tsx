...
import { Search, Bell, User, Volume2, VolumeX, Coins, Flame, Shield, Sparkles, LogOut } from 'lucide-react';
    ...
    <header className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 py-2 select-none">
      ...
      <div className="flex items-center gap-2.5 w-full sm:w-auto justify-end flex-wrap sm:flex-nowrap">
        ...
        <div
          ...
          className="flex items-center gap-1.5 px-3 py-2 rounded-2xl bg-[#E8EDFB] border-2 border-white shadow-[0_4px_12px_rgba(79,114,205,0.15)] text-xs font-black text-[#324B8B] cursor-pointer hover:scale-105 transition-transform"
        ...
        {/* Gold Pill */}
        <div className="flex items-center gap-1.5 px-3 py-2 rounded-2xl bg-[#FDECC8] border-2 border-white shadow-[0_4px_12px_rgba(220,166,66,0.15)] text-xs font-black text-[#6B4B10]">
          <span>🪙</span>
          <span>{profile?.gold || 0}</span>
        </div>

        {/* Streak Pill */}
        <div className="flex items-center gap-1.5 px-3 py-2 rounded-2xl bg-[#FCDAC9] border-2 border-white shadow-[0_4px_12px_rgba(235,139,104,0.15)] text-xs font-black text-[#73351C]">
          <span>🔥</span>
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-2 rounded-2xl bg-rose-50 hover:bg-rose-100 text-rose-700 hover:text-rose-800 border-2 border-rose-200/80 shadow-[0_4px_12px_rgba(225,29,72,0.12)] text-xs font-extrabold hover:scale-105 active:scale-95 transition-all"
